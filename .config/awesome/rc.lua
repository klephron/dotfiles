...
--]]
    ...
    awful.key({modkey}, "o", function () 
      awful.util.spawn_with_shell("rofi -show combi -combi-modi \"drun,run\" -modi combi", false) end, 
      {description = "rofi -show run", group = "rofi"}),
    awful.key({modkey}, "[", function () 
      awful.util.spawn_with_shell("rofi -show window -modi \"window,windowcd\"", false) end, 
