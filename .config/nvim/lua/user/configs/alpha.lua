return function()
  ...
  local buttons = {
    ...
    val = {
      ...
      theme.button("j", icons.Neorg .. " Open neorg journal", "<cmd>lua require('user.configs.neorg').fns.journal()<cr>"),
      theme.button("n", icons.Neorg .. " Switch neorg workspace", "<cmd>lua require('user.configs.neorg').fns.switch_workspace()<cr><cmd>ProjectRoot<cr>"),
