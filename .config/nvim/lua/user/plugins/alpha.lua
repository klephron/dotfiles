return function()
  ...
  local buttons = {
    ...
    val = {
      ...
      theme.button("o", icons.Neorg .. " Open neorg journal", "<cmd>lua plug_require('neorg').fns.journal()<cr>"),
      theme.button("n", icons.Neorg .. " Switch neorg workspace", "<cmd>lua plug_require('neorg').fns.switch_workspace()<cr><cmd>ProjectRoot<cr>"),
