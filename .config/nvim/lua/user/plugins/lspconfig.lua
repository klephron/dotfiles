...
local M = {
  ...
  config = function()
    ...
    local diagnostics = conf_require("config.lsp.diagnostics")
    local formatting = conf_require("config.lsp.formatting")
    local keymaps = conf_require("config.lsp.keymaps")
    local servers = conf_require("config.lsp.servers")
